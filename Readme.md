...
3. Setup the requester and contract on RSK Testnet. Put your test wallet private key in setup.js and then run...
```
...
4. Make a request.
```
npx hardhat run scripts/make-request.js --network testnet
```
